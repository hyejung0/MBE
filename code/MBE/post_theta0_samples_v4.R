...
MCMC_mean_cov_ChrAcu<-function(MCMC_dat,diffuse_se=100, diffuse=TRUE, intercept0=TRUE){
  #MCMC_dat = data table
  ...
  #intercept0 = logical. If TRUE, then the distribution of the intercept term of the meta-regression relating the treatment effect of CE to other surrogates will be centered to 
...
post_theta0_samples_v4<-function(mcmc_dat, sample_dat,diffuse=TRUE, diffuse_se=100, ncores=3, intercept0=TRUE){
  #sample_dat = list of variable value.
  #mcmc_dat = data table
  #ncores = numeric if you want to do parallel
  #diffuse = logical. if we want to change the MCMC samples to have diffuse mean & Variance structure 
  #diffuse_se = SE of the variance for surrogates.
  #intercept0 = logical. If TRUE, then the distribution of the intercept term of the meta-regression relating the treatment effect of CE to other surrogates will be centered to 
